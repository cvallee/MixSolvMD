...
This tutorial requires:
  ...
  - [GROMACS](https://www.gromacs.org) (version from at least 2022)
  - The following Python packages: [py3Dmol](https://pypi.org/project/py3Dmol/), [RDKit](https://www.rdkit.org/docs/index.html), [NumPy](https://numpy.org), [pandas](https://pandas.pydata.org/), [seaborn](https://seaborn.pydata.org/), [matplotlib](https://matplotlib.org), [MolParse](https://github.com/mwinokan/MolParse) and [Gmx_Tools](https://github.com/cvallee/Gmx_Tools)
